...
# Prompt user for the URL and color
echo "Floater bash button"
...
<body class="bg-gray-900 text-gray-100 flex flex-col min-h-screen">
    ...
    <footer class="text-gray-300 text-center p-2 text-sm mt-auto">
         JesseJesse.xyz&nbsp;All Rights Reserved&copy;2024
    </footer>
</body>
</html>
EOL

echo "Floater.js and index.html generated by JesseJesse.xyz All rights Reserved!"
